...
> Vec<crate::models::Email> admin_get_all_emails(page, limit)
List all emails
...
> Vec<crate::models::Email> admin_search_emails(q, page, limit)
Search all emails
...
> Vec<crate::models::User> admin_search_users(source_id, login_name, page, limit)
