...
> crate::models::Issue issue_create_issue_blocking(owner, repo, index, body)
...
> crate::models::Issue issue_create_issue_dependencies(owner, repo, index, body)
...
> Vec<crate::models::Issue> issue_list_blocks(owner, repo, index, page, limit)
...
> Vec<crate::models::Issue> issue_list_issue_dependencies(owner, repo, index, page, limit)
...
> crate::models::Issue issue_remove_issue_blocking(owner, repo, index, body)
...
> crate::models::Issue issue_remove_issue_dependencies(owner, repo, index, body)
...
> Vec<crate::models::Issue> issue_search_issues(state, labels, milestones, q, priority_repo_id, r#type, since, before, assigned, created, mentioned, review_requested, reviewed, owner, team, page, limit)
