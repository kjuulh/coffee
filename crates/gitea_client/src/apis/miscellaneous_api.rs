...
pub async fn get_gitignore_template_info(configuration: &configuration::Configuration, name: &str) -> Result<crate::models::GitignoreTemplateInfo, Error<GetGitignoreTemplateInfoError>> {
...
pub async fn get_label_template_info(configuration: &configuration::Configuration, name: &str) -> Result<Vec<crate::models::LabelTemplate>, Error<GetLabelTemplateInfoError>> {
    let local_var_configuration = configuration;
...
pub async fn get_license_template_info(configuration: &configuration::Configuration, name: &str) -> Result<crate::models::LicenseTemplateInfo, Error<GetLicenseTemplateInfoError>> {
    let local_var_configuration = configuration;
...
pub async fn list_license_templates(configuration: &configuration::Configuration, ) -> Result<Vec<crate::models::LicensesTemplateListEntry>, Error<ListLicenseTemplatesError>> {
    let local_var_configuration = configuration;
...
pub async fn render_markup(configuration: &configuration::Configuration, body: Option<crate::models::MarkupOption>) -> Result<String, Error<RenderMarkupError>> {
    let local_var_configuration = configuration;
